...
Always read these files before creating or editing any UI component:
- `design_system.md`
- `guidingcare-design-system.html`

Use the tokens, patterns, and rules defined there. Do not invent new styles.
